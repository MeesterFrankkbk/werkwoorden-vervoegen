...
const HANDBOEK_DATA = {
  ...
  "TK050105": {
    ...
    persoonsvorm: [
      ...
      {prompt:"(vinden) Zij ... die trucs niet altijd zo geweldig.", answer:"vindt", level:"**"},
  ...
  "TK050505": {
    ...
    persoonsvorm: [
      ...
      {prompt:"(dansen) Ze ... de hele avond in het rond.", answer:"danste(n)", level:"**"},
      ...
      {prompt:"(bereiden) Ze ... heerlijke hapjes.", answer:"bereidde(n)", level:"**"},
      {prompt:"(bakken) Ze ... ook lekkere taartjes.", answer:"bakte(n)", level:"**"},
  ...
  "TK050601": {
    ...
    persoonsvorm: [
      ...
      {prompt:"(steken) Ze ... over, maar werden toch overreden. Zet in de verleden tijd.", answer:"staken", level:"*"},
      ...
      {prompt:"(spelen) Vorige week ... we een volleybalwedstrijd met onze klas.", answer:"speelden", level:"**"},
      {prompt:"(hebben) De leerlingen van de andere school ... veel geoefend.", answer:"hadden", level:"**"},
      {prompt:"(moeten) We ... ons beste beentje voorzetten.", answer:"moesten", level:"**"},
      {prompt:"(komen) De anderen ... eerst op voorsprong.", answer:"kwamen", level:"**"},
      {prompt:"(reageren) Wij ... goed.", answer:"reageerden", level:"**"},
      {prompt:"(zetten) We ... onze achterstand om in winst.", answer:"zetten", level:"**"},
      {prompt:"(organiseren) Morgen ... onze school de terugwedstrijd.", answer:"organiseert", level:"**"},
      {prompt:"(gaan) Jelle, onze topscorer, ... vanmiddag nog extra oefenen.", answer:"gaat", level:"**"},
      {prompt:"(smashen) Hij ... erop los wanneer hij daartoe de kans krijgt.", answer:"smasht", level:"**"},
      {prompt:"(houden) De sportleraar ... morgen eerst nog een training.", answer:"houdt", level:"**"},
      {prompt:"(doen) Ik ... alvast mijn uiterste best om goed te spelen.", answer:"doe", level:"**"},
      {prompt:"(stoten) Bij winst ... onze ploeg door naar de halve finale.", answer:"stoot", level:"**"},
      {prompt:"(beloven) Het ... nog spannend te worden!", answer:"belooft", level:"**"},
      {prompt:"(worden) In Leuven ... een spannende wedstrijd gespeeld.", answer:"werd", level:"***"},
      {prompt:"(gaan) De leerlingen van klas 5 ... de strijd aan met een naburige school.", answer:"gingen", level:"***"},
      {prompt:"(spelen) Tot op de laatste minuut ... men met volle overgave.", answer:"speelde", level:"***"},
      {prompt:"(trillen) Ik ... nog op mijn benen als ik eraan terugdenk.", answer:"tril", level:"***"},
      {prompt:"(maken) In de vijftiende minuut ... Jelle een fantastische goal.", answer:"maakte", level:"***"},
      {prompt:"(behalen) Pas in de laatste minuut ... men het winnende punt.", answer:"behaalde", level:"***"},
      {prompt:"(strijden) Volgend schooljaar ... de kampioenen opnieuw mee voor de titel.", answer:"strijden", level:"***"}
    ],
    zinvtLabel: "Schrijf deze zin in de andere tijd:",
    zinvt: [
  ...
  "TK050603": {
    ...
    persoonsvorm: [
      ...
      {prompt:"(weigeren) Ze ... hun vragen te beantwoorden.", answer:"weigeren", level:"*"},
  ...
  "TK050701": {
    ...
    persoonsvorm: [
      ...
      {prompt:"(rusten, stam+t) Zij ... elke middag.", answer:"rust", level:"*"},
      {prompt:"(rusten, v.t.) Zij ... gisteren ook.", answer:"rustte", level:"*"},
      ...
      {prompt:"(behalen, stam+t) Zij ... goede punten.", answer:"behaalt", level:"*"},
      {prompt:"(behalen, v.t.) Zij ... vorig jaar ook goede punten.", answer:"behaalde", level:"*"}
    ],
    stam: [
  ...
  "TK050706": {
    ...
    persoonsvorm: [
      ...
      {prompt:"(worden, t.t.) Ze ... er echt gelukkig van.", answer:"wordt", level:"***"},
  ...
  "TK050801": {
    ...
    persoonsvorm: [
      ...
      {prompt:"(lopen, t.t.) Zij ...", answer:"loopt", level:"**"},
      ...
      {prompt:"(turnen, v.t.) Zij ...", answer:"turnde", level:"**"},
  ...
  "TK051005": {
    ...
    persoonsvorm: [
      ...
      {prompt:"(poetsen) Een poetsvrouw ... elke dag wel ergens een huis.", answer:"poetste", level:"**"},
      {prompt:"(dweilen) Mijn moeder ... de huiskamer.", answer:"dweilde", level:"**"},
      {prompt:"(stofzuigen) Vader ... de auto twee keer per week.", answer:"stofzuigde", level:"**"},
      {prompt:"(stoffen) Lize en Bram ... hun spullen grondig af.", answer:"stoften af", level:"**"},
      {prompt:"(schilderen) Dit jaar ... we de vuile muren opnieuw.", answer:"schilderden", level:"**"},
      {prompt:"(spoelen) De glazenwasser ... de ruiten grondig.", answer:"spoelde", level:"**"},
      {prompt:"(beluisteren) Bram ... altijd muziek op zijn kamer.", answer:"beluisterde", level:"**"},
      {prompt:"(antwoorden) Daarom ... hij vaak niet.", answer:"antwoordde", level:"**"},
